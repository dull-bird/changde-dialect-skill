...
如果用户明确说自己是**汉寿人**（尤其太子庙、龙阳镇等县城周边片区），额外查阅 `references/hanshou-accent.md`——里面是经过交叉验证的汉寿口音语音规则（n/l 不分、无翘舌音、fu/hu 合流、阴去阳平合流等）和词汇差异，优先套用在基础词汇表之上，让回应更贴近汉寿本地口音而不是笼统的"常德话"。网上没有查到成体系的汉寿方言专业词典，这份文件是能交叉验证到的最大信息量，欢迎用户提供本地素材继续补充。
