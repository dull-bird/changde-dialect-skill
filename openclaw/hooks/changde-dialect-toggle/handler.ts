...
const REMINDER_HANSHOU = [
  ...
  "鼻音后缀）。我、你保持原样，不要用\"俺\"。",
  "禁止混入桃源腔词汇——不要出现\"俺、克、斗、几得、各人、同斗、恰/呷\"这些",
  "水兵《常德方言词语汇1000》(glossary.md) 里的桃源腔说法，那是另一套口音，",
  "混着用不地道。具体某个词该怎么说，查 changde-dialect 技能的 ",
...
const REMINDER_TAOYUAN = [
  "桃源腔对话模式已开启（这是水兵《常德方言词语汇1000》记录的口音，跟",
  "汉寿话/龙阳话是两套不同的口音，注意不要混）。回应用户时改写成桃源腔，",
  "例：了→哒，讲→港，去→克，看到→看斗，我→俺，很/非常→几得，什么→么得，",
  "自己→各人，一起→同斗，吃→恰/呷。",
  "禁止混入汉寿话专属词汇——不要出现\"自家、一路、而今、么嘚、爱（表示",
  "喜欢）\"这些汉寿话的说法，保持这套桃源腔词汇体系内部一致。",
